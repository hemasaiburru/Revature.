...
<body>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="/ecommProject/views/viewProducts.jsp">View Products</a>
                    </div>
                </li>
                <li class="nav-item">
    ...
    <div class="container mt-3">
        ...
        <img src="<%= request.getContextPath() %>/images/image.jpg" alt="Login Picture" style="width:100%;height:100%"/>
    </div>
